...
var Afterparty = /** @class */ (function (_super) {
    ...
    Afterparty.prototype.shouldComponentUpdate = function (nextProps, nextState) {
    ...
    Afterparty.prototype.render = function () {
        ...
        return (React.createElement(react_router_dom_1.Switch, { location: previousLocation || location }, this.props.routes.map(function (r, i) { return (React.createElement(react_router_dom_1.Route, { key: "route--" + i, path: r.path, exact: r.exact, location: previousLocation || location, render: function (props) {
                return React.createElement(r.component, __assign({}, initialData, { history: props.history, match: props.match, prefetch: _this.prefetch }));
            } })); })));
    };
    return Afterparty;
}(React.Component));
